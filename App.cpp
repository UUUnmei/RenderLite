...
App::App()
	: wnd(800, 600, "Main Window"), camera(800, 600, Math::deg2rad(45), (float)800 / 600, 0.1, 1000)
{	}
...
void App::Initial()
{
	...
	//objects = std::make_unique<Object>("obj/mori_knob/testObj.obj");
	objects = std::make_unique<Object>("obj/teapot.obj");
